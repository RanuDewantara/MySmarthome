<?php 
    ...
    // Suhu
    $suhuRG = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qSuhuRG = mysqli_fetch_assoc($suhuRG);
    $suhuA = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qSuhuA = mysqli_fetch_assoc($suhuA);
    $suhuB = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qSuhuB = mysqli_fetch_assoc($suhuB);

    // Kelembapan
    $kelembapanRG = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qKelembapanRG = mysqli_fetch_array($kelembapanRG, MYSQLI_ASSOC);
    $kelembapanA = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qKelembapanA = mysqli_fetch_array($kelembapanA, MYSQLI_ASSOC);
    $kelembapanB = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qKelembapanB = mysqli_fetch_array($kelembapanB, MYSQLI_ASSOC);

    // Daya
    $dayaRG = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qDayaRG = mysqli_fetch_array($dayaRG, MYSQLI_ASSOC);
    $dayaA = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qDayaA = mysqli_fetch_array($dayaA, MYSQLI_ASSOC);
    $dayaB = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qDayaB = mysqli_fetch_array($dayaB, MYSQLI_ASSOC);

    // Tegangan
    $teganganRG = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qTeganganRG = mysqli_fetch_array($teganganRG, MYSQLI_ASSOC);
    $teganganA = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qTeganganA = mysqli_fetch_array($teganganA, MYSQLI_ASSOC);
    $teganganB = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qTeganganB = mysqli_fetch_array($teganganB, MYSQLI_ASSOC);

    // Arus
    $arusRG = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qArusRG = mysqli_fetch_array($arusRG, MYSQLI_ASSOC);
    $arusA = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qArusA = mysqli_fetch_array($arusA, MYSQLI_ASSOC);
    $arusB = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qArusB = mysqli_fetch_array($arusB, MYSQLI_ASSOC);

    // Energi
    $energiRG = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qEnergiRG = mysqli_fetch_array($energiRG, MYSQLI_ASSOC);
    $energiA = mysqli_query($conn, "SELECT * FROM data_ruangan");
    $qEnergiA = mysqli_fetch_array($energiA, MYSQLI_ASSOC);
    $energiB = mysqli_query($conn, "SELECT * FROM data_ruangan");
